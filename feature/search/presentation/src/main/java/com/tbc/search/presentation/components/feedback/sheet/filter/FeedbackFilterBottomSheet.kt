package com.tbc.search.presentation.components.feedback.sheet.filter
...
import com.tbc.search.presentation.mapper.review.toStringRes

@Composable
fun FeedbackFilterBottomSheet(
    options: List<FeedbackFilterType>,
    selectedSortType: FeedbackFilterType,
    onItemClick: (FeedbackFilterType) -> Unit,
) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
