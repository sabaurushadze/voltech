package com.tbc.search.presentation.components.feedback.sheet.sort
...
@Composable
fun FeedbackSortBottomSheet(
    options: List<FeedbackSortType>,
    selectedSortType: FeedbackSortType,
    onItemClick: (FeedbackSortType) -> Unit,
) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
